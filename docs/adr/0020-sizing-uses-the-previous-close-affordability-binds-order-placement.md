...
- **The proposal's expiry**: the next bar, or the second subsequent bar for a fill-chained Add (ADR 0011's 2026-09-24 amendment; the next bar after all if that bar proposes an exit or a stop has closed the Campaign), or the end of the stream.
