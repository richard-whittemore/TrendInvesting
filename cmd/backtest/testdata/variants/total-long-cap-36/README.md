# Declared Variant: total-long-cap-36
...
36, plus its identifying `strategy_id`. The Baseline remains 12.
...
Run `go test ./cmd/backtest -run 'TestDeclaredVariantGolden/total-long-cap-36'`.
